...
**[[ImagePolicyWebhook]]** is a built-in [[Admission Controllers]] in Kubernetes that lets users enforce custom security policies on container images using a **webhook** (external service)
